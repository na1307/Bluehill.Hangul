...
public static class CharExtensions {
    ...
    /// <returns><paramref name="hangulChar"/>의 초성에 해당하는 <see cref="Hangul.Choseong"/> 값</returns>
    /// <exception cref="ArgumentException"><paramref name="hangulChar"/>가 한글 음절이 아님</exception>
    public static Choseong Choseong(this char hangulChar) => ((HangulSyllable)hangulChar).Choseong;

    /// <summary>
    /// 이 한글 음절의 중성에 해당하는 <see cref="Hangul.Jungseong"/> 값을 반환함
    /// </summary>
    /// <param name="hangulChar">한글 음절</param>
    /// <returns><paramref name="hangulChar"/>의 초성에 해당하는 <see cref="Hangul.Jungseong"/> 값</returns>
    /// <exception cref="ArgumentException"><paramref name="hangulChar"/>가 한글 음절이 아님</exception>
    public static Jungseong Jungseong(this char hangulChar) => ((HangulSyllable)hangulChar).Jungseong;

    /// <summary>
    /// 이 한글 음절의 종성에 해당하는 <see cref="Hangul.Jongseong"/> 값을 반환함
    /// </summary>
    /// <param name="hangulChar">한글 음절</param>
    /// <returns><paramref name="hangulChar"/>의 초성에 해당하는 <see cref="Hangul.Jongseong"/> 값</returns>
    /// <exception cref="ArgumentException"><paramref name="hangulChar"/>가 한글 음절이 아님</exception>
    public static Jongseong Jongseong(this char hangulChar) => ((HangulSyllable)hangulChar).Jongseong;
}