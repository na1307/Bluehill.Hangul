...
public static class EnumExtensions {
    ...
    public static char ToChar(this Choseong choseong) => JamoLookup[ChoseongIndex][(int)choseong];
    ...
    public static char ToChar(this Jungseong jungseong) => JamoLookup[JungseongIndex][(int)jungseong];
    ...
    public static char ToChar(this Jongseong jongseong) => JamoLookup[JongseongIndex][(int)jongseong];
}