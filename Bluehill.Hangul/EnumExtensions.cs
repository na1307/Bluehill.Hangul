...
public static class EnumExtensions {
    ...
    public static char ToChar(this Choseong choseong) => Choseongs[(int)choseong];
    ...
    public static char ToChar(this Jungseong jungseong) => Jungseongs[(int)jungseong];
    ...
    public static char ToChar(this Jongseong jongseong) => Jongseongs[(int)jongseong];
}